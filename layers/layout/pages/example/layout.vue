...
import { initialEdges, initialNodes } from '../../assets/layout-initial-elements.js'
import { useLayout as useGraphLayout } from '../../composables/useLayout'
...
const { graph, layout } = useGraphLayout()
...
definePageMeta({
  ...
  description: 'Vue Flow layout example with Dagre automatic positioning and process animation'
})
</script>
